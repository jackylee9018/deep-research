...
export type PromptInputProps = {
  ...
  placeholder?: string;
  disabled?: boolean;
  /** Replaces the default “+” control on the left side of the toolbar. */
  toolbarLeft?: ReactNode;
  /** When false, always shows the send button (no voice mode). */
  showVoiceControls?: boolean;
  submitAriaLabel?: string;
};

/** Home / research shared Open WebUI–style prompt box. */
  ...
  return (
    ...
    >
      <div
        ...
        className="owui-message-input-container"
      >
            ...
            {showVoiceControls && hasContent ? (
              ...
              <PromptToolbarIconTip tip={submitAriaLabel}>
                <button
                  type="submit"
                  id="send-message-button"
                  className={`owui-send-btn ${hasContent ? 'owui-send-btn--active' : ''}`}
                  aria-label={submitAriaLabel}
                  title={submitAriaLabel}
