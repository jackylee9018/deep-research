...
import type { PptHistoryEntry } from '../lib/ppt-history';
import type { PptJob } from '../lib/ppt-client-jobs';
...
export function PptSidebarPanel() {
  const nav = useOptionalPptNavHandlers();
    ...
    <li>
      ...
      >
        <button
          ...
          onClick={onSelect}
        >
          <span className="research-sidebar-chat-title">
            {job.outlineTitle}
          </span>
    ...
    <li>
      ...
      >
        ...
        >
          ...
          <span className="research-sidebar-chat-meta">
            {entry.slideCount != null ? `${entry.slideCount} 頁 · ` : ''}
